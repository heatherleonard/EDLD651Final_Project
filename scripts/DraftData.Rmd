...
To examine the relationship between internet overuse and sleep outcomes, we ran two Pearson's correlation analyses. First, we tested the association between internet overuse and average sleep on school nights. The results indicated that these two variables are not significantly associated r(337) = -0.04, p  = .46. However, internet overuse was positively correlated with reported daytime sleepiness r(335) = .18, p  < .001, indicating that as reports of internet overuse increase, reports of daytime sleepiness also increase.   
