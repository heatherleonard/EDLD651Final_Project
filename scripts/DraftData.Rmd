...
Given this information, the present study aims to explore the association of adolescent internet overuse and sleep outcomes, including exploratory visuals and statistical summary of the data. Our research question asks: Is internet overuse correlated with sleep outcomes (total sleep, daytime sleepiness) in adolescents? 
...
cor.test(synthdata$io_comp, as.numeric(synthdata$lunch_RC), method = "pearson", use = "complete.obs")
