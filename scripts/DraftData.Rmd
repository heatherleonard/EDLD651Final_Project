...
#note from Abbie: I don't think we need this 
synthdata %>% 
  group_by(dm_sex_bl) %>% 
...
#note from Abbie: I am having issues here with the renaming
...
synthdata %>%
  ...
  rename (Grade = grade, 
          ...
          Free/reduced lunch = dm_lunch_bl, 
          Race = dm_race_bl, 
          Average daytime sleepiness = sl_sleepy_bl, 
          Average weekly hours of sleep per night = sl_avgsleepcat_bl, 
          Average internet overuse = io_comp) %>% 
